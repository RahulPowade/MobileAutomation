...
public class udid {
		...
		public static void main(String[] args) throws MalformedURLException, InterruptedException {
			...
			cap.setCapability("udid", "emulator-5554");// use this when you have multiple devices connected and you need to use any spcific device. for device run in cmd "adb devices"
